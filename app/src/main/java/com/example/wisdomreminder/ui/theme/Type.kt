...
// Typography for our futuristic app
val Typography = Typography(
    // Large display text for wisdom quotes
    ...
    // Reference text for wisdom sources
    ...
    // Small text for metadata and stats
    bodySmall = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Normal,
        fontSize = 12.sp,
